      ...
      <div className="flex justify-between bg-white border-gray-400 shadow">
        ...
        <div className="flex items-center justify-center transition-colors h-20 bg-white rounded-br-md p-2.5 md:px-6">
          <Link
            to="/"
            onClick={closeMenu}
            className="flex gap-2 items-center font-alt font-bold uppercase text-lg xs:text-xl sm:text-2xl md:whitespace-nowrap leading-none"
          >
            <img src={logo} alt="Trainer Supply Co Logo" />
          </Link>
        </div>
