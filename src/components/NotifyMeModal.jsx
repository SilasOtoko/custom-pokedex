    ...
    >
      <div className="p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-bold text-gray-800">Notify Me</h2>
          <button
            type="button"
            onClick={handleClose}
            aria-label="Close"
        ...
        <p className="text-sm text-gray-500 mb-6">
          The Master Ball is incredibly rare. Enter your email and we'll let you
          know the moment one becomes available.
        </p>
